"""
Biometric AI Microservice - FaceNet + MTCNN
Exposes REST endpoints for face detection, embedding, and verification.
"""
...
from routes.liveness import liveness_bp   # <-- import the liveness blueprint
...
def create_app() -> Flask:
    ...
    # Register blueprints (all inside the function)
    app.register_blueprint(health_bp)
    app.register_blueprint(detect_bp)
    app.register_blueprint(embed_bp)
    app.register_blueprint(verify_bp)
    app.register_blueprint(verify_id_bp)
    app.register_blueprint(liveness_bp)   # <-- register here
